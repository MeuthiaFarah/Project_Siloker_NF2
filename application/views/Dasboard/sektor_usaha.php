				...
				<div class="wrap-table100">
					<div class="table100">
						<table>
							...
							<!-- menampilkan data -->
							<?php foreach ($sektor_usahas as $sektor_usaha) : ?>
								<tr>
									<td style="text-align: center;"><?php echo $sektor_usaha->id ?> </td>
									<td style="text-align: center;"><?php echo $sektor_usaha->nama ?> </td>
								</tr>
							<?php endforeach ?>
						</table>
					</div>
