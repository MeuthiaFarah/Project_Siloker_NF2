						...
						<table>
							<thead>
								<tr class="table100-head">
									...
									<th class="column3" style="text-align: center;">Nama Bidang usaha</th>
									<th class="column4" style="text-align: center;">Alamat sektor usaha</th>
									<th class="column5" style="text-align: center;">Kontak</th>
									<th class="column6" style="text-align: center;">Telfon</th>
									<th class="column7" style="text-align: center;">Email</th>
									<th class="column8" style="text-align: center;">web</th>
								</tr>
							</thead>
							<!-- menampilkan data -->
							<?php foreach ($mitras as $mitra) : ?>
								<tr>
									<td style="text-align: center;"><?php echo $mitra->id ?> </td>
									<td style="text-align: center;"><?php echo $mitra->nama ?> </td>
									<td style="text-align: center;"><?php echo $mitra->alamat ?> </td>
									<td style="text-align: center;"><?php echo $mitra->kontak ?> </td>
									<td style="text-align: center;"><?php echo $mitra->telpon ?> </td>
									<td style="text-align: center;"><?php echo $mitra->email ?> </td>
									<td style="text-align: center;"><?php echo $mitra->web ?> </td>
								</tr>
							<?php endforeach ?>
						</table>
					</div>
