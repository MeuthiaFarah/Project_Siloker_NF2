						...
						<table>
							<thead>
								<tr class="table100-head">
									...
									<th class="column3" style="text-align: center;">Kode</th>
									<th class="column4" style="text-align: center;">Nama</th>
								</tr>
							</thead>
							<!-- menampilkan data -->
							<?php foreach ($prodis as $prodi) : ?>
								<tr>
									<td style="text-align: center;"><?php echo $prodi->id ?> </td>
									<td style="text-align: center;"><?php echo $prodi->kode ?> </td>
									<td style="text-align: center;"><?php echo $prodi->nama ?> </td>
								</tr>
							<?php endforeach ?>
						</table>
					</div>
